...
public class JavaCodeGenerator extends CodeGenerator {
    ...
    public String j6(Vector vector) {
        ...
        stringBuffer.append(new StringBuffer().append("(").append(this.Hw).append(")astFactory.make( (new ASTArray(").append(vector.DW()).append("))").toString());
    ...
    public String j6(GrammarAtom grammarAtom, String str) {
        ...
        return new StringBuffer().append("(").append(grammarAtom.v5()).append(")").append("astFactory.create(").append(str).append(",\"").append(grammarAtom.v5()).append("\")").toString();
    }
    ...
    public String DW(String str) {
        ...
        if (i2 >= 2) {
            return new StringBuffer().append("(").append(this.Hw).append(")astFactory.create(").append(str).append(")").toString();
        }
        String substring;
        i = str.indexOf(44);
        str.lastIndexOf(44);
        ...
        if (j6 != null) {
            ...
            if (j62 != null) {
                return new StringBuffer().append("(").append(j62).append(")").append("astFactory.create(").append(str).append(substring).append(",\"").append(j62).append("\")").toString();
            }
        }
        if (this.Hw.equals("AST")) {
            return new StringBuffer().append("astFactory.create(").append(str).append(")").toString();
        }
        return new StringBuffer().append("(").append(this.Hw).append(")").append("astFactory.create(").append(str).append(")").toString();
    }
