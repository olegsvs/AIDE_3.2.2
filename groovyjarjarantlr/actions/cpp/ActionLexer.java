...
public class ActionLexer extends CharScanner implements TokenStream, ActionLexerTokenTypes {
    ...
    protected final void FH(boolean z) {
        ...
        if (DW(1) == '#' && DW(2) == '(') {
            ...
            token2 = this.J8;
            String FH = token2.FH();
            r3 = this.DW.j6(token2.FH(), this.FH);
            if (r3 != null && !FH.equals(r3)) {
                this.VH.j6(DW);
                this.VH.j6(r3);
            } else if (FH.equals("if") || FH.equals("define") || FH.equals("ifdef") || FH.equals("ifndef") || FH.equals("else") || FH.equals("elif") || FH.equals("endif") || FH.equals("warning") || FH.equals("error") || FH.equals("ident") || FH.equals("pragma") || FH.equals("include")) {
                this.VH.j6(DW);
                this.VH.j6(new StringBuffer().append("#").append(FH).toString());
            }
            if (Mr.Hw(DW(1))) {
                u7(false);
            }
    ...
    protected final void Hw(boolean z) {
        ...
        if (DW(1) == '$' && DW(2) == 'F' && DW(3) == 'O') {
            ...
            token = this.J8;
            DW(')');
            FH2 = new StringBuffer().append("text += ").append(token.FH()).toString();
            this.VH.j6(DW);
            this.VH.j6(FH2);
        } else if (DW(1) == '$' && DW(2) == 's') {
            j6("$set");
            if (DW(1) == 'T' && DW(2) == 'e') {
                ...
                token = this.J8;
                DW(')');
                FH2 = new StringBuffer().append("{ text.erase(_begin); text += ").append(token.FH()).append("; }").toString();
                this.VH.j6(DW);
                this.VH.j6(FH2);
            ...
            j6("$getText");
            this.VH.j6(DW);
            this.VH.j6("text.substr(_begin,text.length()-_begin)");
        } else {
            throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
        }
        if (z && null == null) {
    ...
    protected final void gn(boolean z) {
        ...
        J8(true);
        this.VH.j6(DW2);
        vector.j6(this.DW.j6(this.J8.FH()));
        switch (DW(1)) {
            case '\t':
            case '\n':
            case '\r':
    ...
    protected final void we(boolean z) {
        ...
        DW(']');
        this.VH.j6(DW);
        String j6 = this.DW.j6(token3.FH());
        if (token != null) {
            stringBuffer = new StringBuffer().append(j6).append(",").append(token.FH()).toString();
        } else {
            stringBuffer = j6;
        }
        this.VH.j6(DW2);
        ...
        if (z && null == null) {
            token2 = FH(10);
            token2.j6(new String(this.VH.j6(), DW2, this.VH.DW() - DW2));
        }
        this.J8 = token2;
    }
    ...
    protected final void J0(boolean z) {
        ...
        int i = 0;
        while (yS.Hw(DW(1)) && DW(2) >= '\u0003' && DW(2) <= '\u00ff') {
            j3(false);
            if (Mr.Hw(DW(1)) && gW.Hw(DW(2))) {
                u7(false);
            } else if (!gW.Hw(DW(1))) {
                throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
            }
    ...
    protected final boolean Ws(boolean z) {
        ...
        switch (DW(1)) {
            ...
            case '<':
                ...
                DW('(');
                if (Mr.Hw(DW(1)) && ei.Hw(DW(2)) && DW(3) >= '\u0003' && DW(3) <= '\u00ff') {
                    DW3 = this.VH.DW();
                    u7(false);
                    this.VH.j6(DW3);
                } else if (!ei.Hw(DW(1)) || DW(2) < '\u0003' || DW(2) > '\u00ff') {
                    throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
                }
                switch (DW(1)) {
                    case '\t':
            ...
            default:
                if (DW(1) == '-' && DW(2) == '>' && BT.Hw(DW(3))) {
                    ...
                    if (SI.Hw(DW(1)) && nw.Hw(DW(2)) && this.FH != null && this.FH.DW != null) {
                        switch (DW(1)) {
                            case '\t':
                            case '\n':
                            case '\r':
    ...
    protected final void QX(boolean z) {
        ...
        if (DW(1) == '\"' && DW(2) >= '\u0003' && DW(2) <= '\u00ff' && DW(3) >= '\u0003' && DW(3) <= '\u00ff') {
            Zo(false);
        } else if (ro.Hw(DW(1)) && DW(2) >= '\u0003' && DW(2) <= '\u00ff') {
            J8(false);
    ...
    protected final void aM(boolean z) {
        ...
        switch (DW(1)) {
            ...
            case '9':
                ...
                break;
            default:
                if (!ro.Hw(DW(1)) || DW(2) < '\u0003' || DW(2) > '\u00ff' || DW(3) < '\u0003' || DW(3) > '\u00ff') {
                    if (DW(1) == '\"' && DW(2) >= '\u0003' && DW(2) <= '\u00ff' && DW(3) >= '\u0003' && DW(3) <= '\u00ff') {
                        Zo(false);
                        break;
                    }
        ...
        while (cn.Hw(DW(1)) && sh.Hw(DW(2)) && DW(3) >= '\u0003' && DW(3) <= '\u00ff') {
            switch (DW(1)) {
                case '\t':
                case '\n':
                case '\r':
        ...
        switch (DW(1)) {
            case '(':
                ...
                if (Mr.Hw(DW(1)) && dx.Hw(DW(2)) && DW(3) >= '\u0003' && DW(3) <= '\u00ff') {
                    ...
                    u7(false);
                    this.VH.j6(DW2);
                } else if (!dx.Hw(DW(1)) || DW(2) < '\u0003' || DW(2) > '\u00ff') {
                    throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
                }
                while (sG.Hw(DW(1)) && DW(2) >= '\u0003' && DW(2) <= '\u00ff' && DW(3) >= '\u0003' && DW(3) <= '\u00ff') {
                    J0(false);
                    while (DW(1) == ',') {
                        DW(',');
                        J0(false);
            ...
            case '[':
                ...
                while (DW(1) == '[') {
                    int DW3;
                    DW('[');
                    if (Mr.Hw(DW(1)) && sG.Hw(DW(2)) && DW(3) >= '\u0003' && DW(3) <= '\u00ff') {
                        DW3 = this.VH.DW();
                        u7(false);
                        this.VH.j6(DW3);
                    } else if (!sG.Hw(DW(1)) || DW(2) < '\u0003' || DW(2) > '\u00ff' || DW(3) < '\u0003' || DW(3) > '\u00ff') {
                        throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
                    }
                    J0(false);
                    switch (DW(1)) {
    ...
    protected final void U2(boolean z) {
        ...
        if (i >= 1) {
            Token FH;
            if (DW(1) == 'L' && Sf.Hw(DW(2))) {
                DW('L');
            } else if (DW(1) == 'l' && Sf.Hw(DW(2))) {
                DW('l');
            } else if (DW(1) == '.') {
                DW('.');
                while (DW(1) >= '0' && DW(1) <= '9' && Sf.Hw(DW(2))) {
                    er(false);
                }
            } else if (!Sf.Hw(DW(1))) {
                throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
    ...
    L_0x00e6:
        ...
        goto L_0x0016;
        */
        throw new UnsupportedOperationException("Method not decompiled: groovyjarjarantlr.actions.cpp.ActionLexer.lg(boolean):void");
    }
