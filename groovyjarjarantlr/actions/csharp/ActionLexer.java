...
public class ActionLexer extends CharScanner implements TokenStream, ActionLexerTokenTypes {
    ...
    protected final void FH(boolean z) {
        ...
        if (DW(1) == '#' && DW(2) == '(') {
            ...
            if (r3 != null && !FH.equals(r3)) {
                this.VH.j6(DW);
                this.VH.j6(r3);
            } else if (FH.equals("define") || FH.equals("undef") || FH.equals("if") || FH.equals("elif") || FH.equals("else") || FH.equals("endif") || FH.equals("line") || FH.equals("error") || FH.equals("warning") || FH.equals("region") || FH.equals("endregion")) {
                this.VH.j6(DW);
    ...
    protected final void Hw(boolean z) {
        ...
        if (DW(1) == '$' && DW(2) == 'F' && DW(3) == 'O') {
            ...
            if (DW(1) == 'T' && DW(2) == 'e') {
                ...
                token = this.J8;
                DW(')');
                FH2 = new StringBuffer().append("text.Length = _begin; text.Append(").append(token.FH()).append(")").toString();
                this.VH.j6(DW);
                this.VH.j6(FH2);
            ...
            j6("$getText");
            this.VH.j6(DW);
            this.VH.j6("text.ToString(_begin, text.Length-_begin)");
        } else {
            throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
        }
        if (z && null == null) {
    ...
    protected final void we(boolean z) {
        ...
        DW(']');
        this.VH.j6(DW);
        String j6 = this.DW.j6(token4.FH());
        if (token != null) {
    ...
    L_0x00e6:
        ...
        goto L_0x0016;
        */
        throw new UnsupportedOperationException("Method not decompiled: groovyjarjarantlr.actions.csharp.ActionLexer.lg(boolean):void");
    }
