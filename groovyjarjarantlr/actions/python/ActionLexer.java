...
public class ActionLexer extends CharScanner implements TokenStream, ActionLexerTokenTypes {
    ...
    protected final void Hw(boolean z) {
        ...
        if (DW(1) == '$' && DW(2) == 's' && DW(3) == 'e') {
            ...
            if (DW(1) == 'T' && DW(2) == 'e') {
                ...
                token = this.J8;
                DW(')');
                stringBuffer = new StringBuffer().append("self.text.setLength(_begin) ; self.text.append(").append(token.FH()).append(")").toString();
                this.VH.j6(DW);
                ...
                token = this.J8;
                DW(')');
                stringBuffer = new StringBuffer().append("_token = ").append(token.FH()).toString();
                this.VH.j6(DW);
                this.VH.j6(stringBuffer);
                ...
                token = this.J8;
                DW(')');
                stringBuffer = new StringBuffer().append("_ttype = ").append(token.FH()).toString();
                this.VH.j6(DW);
                this.VH.j6(stringBuffer);
            } else {
                throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
            }
        } else if (DW(1) == '$' && DW(2) == 'F' && DW(3) == 'O') {
            j6("$FOLLOW");
            ...
            r1 = this.j6.FH();
            if (token != null) {
                stringBuffer = token.FH();
            } else {
                stringBuffer = r1;
            }
            r1 = this.DW.j6(stringBuffer, 1);
            if (r1 == null) {
                FH(new StringBuffer().append("$FOLLOW(").append(stringBuffer).append(")").append(": unknown rule or bad lookahead computation").toString());
            } else {
                this.VH.j6(DW);
                this.VH.j6(r1);
            }
            ...
            r1 = this.DW.DW(stringBuffer, 1);
            if (r1 == null) {
                FH(new StringBuffer().append("$FIRST(").append(stringBuffer).append(")").append(": unknown rule or bad lookahead computation").toString());
            } else {
                this.VH.j6(DW);
                this.VH.j6(r1);
            }
        } else if (DW(1) == '$' && DW(2) == 's' && DW(3) == 'k') {
            j6("$skip");
            this.VH.j6(DW);
            this.VH.j6("_ttype = SKIP");
        } else if (DW(1) == '$' && DW(2) == 'a') {
            j6("$append");
            switch (DW(1)) {
                case '\t':
            ...
            token = this.J8;
            DW(')');
            stringBuffer = new StringBuffer().append("self.text.append(").append(token.FH()).append(")").toString();
            this.VH.j6(DW);
            this.VH.j6(stringBuffer);
        } else if (DW(1) == '$' && DW(2) == 'g') {
            j6("$getText");
            this.VH.j6(DW);
            this.VH.j6("self.text.getString(_begin)");
        } else if (DW(1) == '$' && DW(2) == 'n') {
            if (DW(1) == '$' && DW(2) == 'n' && DW(3) == 'l') {
                j6("$nl");
            } else if (DW(1) == '$' && DW(2) == 'n' && DW(3) == 'e') {
                j6("$newline");
            } else {
                throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
            }
            this.VH.j6(DW);
            this.VH.j6("self.newline()");
        } else {
            throw new NoViableAltForCharException(DW(1), v5(), Zo(), Hw());
        }
        if (z && null == null) {
    ...
    L_0x014c:
        ...
        goto L_0x0023;
        */
        throw new UnsupportedOperationException("Method not decompiled: groovyjarjarantlr.actions.python.ActionLexer.lg(boolean):void");
    }

    /* JADX WARNING: inconsistent code. */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    protected final void rN(boolean r11) {
        /*
        r10 = this;
        r9 = 9;
        r8 = 1;
    ...
    L_0x0075:
        ...
        return;
        */
        throw new UnsupportedOperationException("Method not decompiled: groovyjarjarantlr.actions.python.ActionLexer.rN(boolean):void");
    }
