.class Lcom/google/android/gms/measurement/internal/p$c;
.super Landroid/database/sqlite/SQLiteOpenHelper;


# annotations
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/google/android/gms/measurement/internal/p;
.end annotation
...
# instance fields
.field final synthetic j6:Lcom/google/android/gms/measurement/internal/p;


# direct methods
.method constructor <init>(Lcom/google/android/gms/measurement/internal/p;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2

    iput-object p1, p0, Lcom/google/android/gms/measurement/internal/p$c;->j6:Lcom/google/android/gms/measurement/internal/p;
...
.method private DW(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
    .locals 3
...
.method private j6(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/measurement/internal/p$c;->j6(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    ...
    :cond_0
    :try_start_0
    invoke-direct {p0, p1, p2, p4, p5}, Lcom/google/android/gms/measurement/internal/p$c;->j6(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    :try_end_0
    ...
    iget-object v1, p0, Lcom/google/android/gms/measurement/internal/p$c;->j6:Lcom/google/android/gms/measurement/internal/p;

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/p;->lg()Lcom/google/android/gms/measurement/internal/aa;
    ...
    invoke-virtual {v1, v2, p2}, Lcom/google/android/gms/measurement/internal/aa$a;->j6(Ljava/lang/String;Ljava/lang/Object;)V

    throw v0
.end method

.method private j6(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/measurement/internal/p$c;->DW(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Ljava/util/Set;
...
.method private j6(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;)Z
    .locals 10
    ...
    :goto_1
    :try_start_2
    iget-object v2, p0, Lcom/google/android/gms/measurement/internal/p$c;->j6:Lcom/google/android/gms/measurement/internal/p;

    invoke-virtual {v2}, Lcom/google/android/gms/measurement/internal/p;->lg()Lcom/google/android/gms/measurement/internal/aa;
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iget-object v0, p0, Lcom/google/android/gms/measurement/internal/p$c;->j6:Lcom/google/android/gms/measurement/internal/p;

    invoke-static {v0}, Lcom/google/android/gms/measurement/internal/p;->j6(Lcom/google/android/gms/measurement/internal/p;)Lcom/google/android/gms/measurement/internal/h;

    move-result-object v0

    iget-object v1, p0, Lcom/google/android/gms/measurement/internal/p$c;->j6:Lcom/google/android/gms/measurement/internal/p;

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/p;->er()Lcom/google/android/gms/measurement/internal/o;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/o;->KD()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Lcom/google/android/gms/measurement/internal/h;->j6(J)Z
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/measurement/internal/p;->lg()Lcom/google/android/gms/measurement/internal/aa;
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/p;->XL()Landroid/content/Context;
    ...
    invoke-static {v1}, Lcom/google/android/gms/measurement/internal/p;->j6(Lcom/google/android/gms/measurement/internal/p;)Lcom/google/android/gms/measurement/internal/h;

    move-result-object v1

    invoke-virtual {v1}, Lcom/google/android/gms/measurement/internal/h;->DW()V
    :try_end_1
    .catch Landroid/database/sqlite/SQLiteException; {:try_start_1 .. :try_end_1} :catch_1
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-direct/range {v0 .. v5}, Lcom/google/android/gms/measurement/internal/p$c;->j6(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {}, Lcom/google/android/gms/measurement/internal/p;->ro()Ljava/util/Map;
    ...
    invoke-direct/range {v6 .. v11}, Lcom/google/android/gms/measurement/internal/p$c;->j6(Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
