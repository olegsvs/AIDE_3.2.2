...
public final class i {
    public static Bitmap j6(Bitmap bitmap) {
        int i = 0;
        if (bitmap == null) {
            return null;
        }
    ...
    private static Bitmap j6(Drawable drawable) {
        if (drawable == null) {
            return null;
        }
    ...
    public static Drawable j6(Resources resources, Drawable drawable) {
        return new BitmapDrawable(resources, j6(j6(drawable)));
    }
}
