...
public class bm implements al, am {
    private final Bundle DW;
    private List FH;
    private Builder j6;

    public bm(Context context, Notification notification, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, RemoteViews remoteViews, int i, PendingIntent pendingIntent, PendingIntent pendingIntent2, Bitmap bitmap, int i2, int i3, boolean z, boolean z2, int i4, CharSequence charSequence4, boolean z3, Bundle bundle, String str, boolean z4, String str2) {
        boolean z5;
    ...
    public Notification DW() {
        ...
        j6.putAll(bundle);
        SparseArray j62 = bl.j6(this.FH);
        if (j62 != null) {
            bl.j6(build).putSparseParcelableArray("android.support.actionExtras", j62);
        }
        return build;
    }
}
