...
# static fields
.field static final j6:Landroid/support/v4/widget/ae;
...
.field private QX:Landroid/support/v4/widget/ad;
...
.field private final XL:Landroid/support/v4/widget/aj;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->j6:Landroid/support/v4/widget/ae;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/aa;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;)V

    invoke-static {p0, v1}, Landroid/support/v4/view/ak;->j6(Landroid/view/View;Landroid/support/v4/view/a;)V

    .line 268
    invoke-static {p0, v2}, Landroid/support/v4/view/ak;->FH(Landroid/view/View;I)V
    ...
    invoke-direct {v1, p0, v2}, Landroid/support/v4/widget/ac;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/support/v4/widget/SlidingPaneLayout$1;)V

    invoke-static {p0, v3, v1}, Landroid/support/v4/widget/aj;->j6(Landroid/view/ViewGroup;FLandroid/support/v4/widget/ak;)Landroid/support/v4/widget/aj;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;

    .line 271
    iget-object v1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;
...
.method static synthetic DW(Landroid/support/v4/widget/SlidingPaneLayout;)Landroid/support/v4/widget/aj;
    .locals 1

    .prologue
    .line 89
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;
...
.method static synthetic FH(Landroid/support/v4/widget/SlidingPaneLayout;)F
    .locals 1
...
.method static synthetic Hw(Landroid/support/v4/widget/SlidingPaneLayout;)Landroid/view/View;
    .locals 1
...
.method static synthetic VH(Landroid/support/v4/widget/SlidingPaneLayout;)Ljava/util/ArrayList;
    .locals 1
...
.method private VH(Landroid/view/View;)V
    .locals 1

    .prologue
    .line 1038
    sget-object v0, Landroid/support/v4/widget/SlidingPaneLayout;->j6:Landroid/support/v4/widget/ae;

    invoke-interface {v0, p0, p1}, Landroid/support/v4/widget/ae;->j6(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V

    .line 1039
    return-void
.end method

.method static synthetic Zo(Landroid/support/v4/widget/SlidingPaneLayout;)I
    .locals 1
...
.method private static Zo(Landroid/view/View;)Z
    .locals 4
    ...
    .line 408
    invoke-static {p0}, Landroid/support/v4/view/ak;->VH(Landroid/view/View;)Z
...
.method private j6(F)V
    ...
    .line 1186
    invoke-direct {p0}, Landroid/support/v4/widget/SlidingPaneLayout;->Zo()Z
    ...
    .line 1188
    iget-boolean v2, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->FH:Z
    ...
    iget v7, p0, Landroid/support/v4/widget/SlidingPaneLayout;->J0:I
...
.method private j6(I)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/widget/SlidingPaneLayout;->j6(Landroid/view/View;)V
...
.method static synthetic j6(Landroid/support/v4/widget/SlidingPaneLayout;I)V
    .locals 0

    .prologue
    .line 89
    invoke-direct {p0, p1}, Landroid/support/v4/widget/SlidingPaneLayout;->j6(I)V

    return-void
.end method

.method static synthetic j6(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
    .locals 0

    .prologue
    .line 89
    invoke-direct {p0, p1}, Landroid/support/v4/widget/SlidingPaneLayout;->VH(Landroid/view/View;)V
...
.method private j6(Landroid/view/View;FI)V
    ...
    .line 974
    iget-object v2, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->Hw:Landroid/graphics/Paint;
    ...
    iput-object v2, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->Hw:Landroid/graphics/Paint;
    ...
    .line 978
    invoke-static {p1}, Landroid/support/v4/view/ak;->Hw(Landroid/view/View;)I
    ...
    .line 979
    iget-object v0, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->Hw:Landroid/graphics/Paint;

    invoke-static {p1, v5, v0}, Landroid/support/v4/view/ak;->j6(Landroid/view/View;ILandroid/graphics/Paint;)V
    ...
    .line 983
    iget-object v1, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->Hw:Landroid/graphics/Paint;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v4/widget/ab;-><init>(Landroid/support/v4/widget/SlidingPaneLayout;Landroid/view/View;)V
...
.method static synthetic j6(Landroid/support/v4/widget/SlidingPaneLayout;)Z
    .locals 1

    .prologue
    .line 89
    iget-boolean v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->we:Z

    return v0
.end method

.method static synthetic j6(Landroid/support/v4/widget/SlidingPaneLayout;Z)Z
    .locals 0
...
.method static synthetic v5(Landroid/support/v4/widget/SlidingPaneLayout;)Z
    .locals 1
...
.method DW(Landroid/view/View;)V
    ...
    .prologue
    .line 339
    iget-object v0, p0, Landroid/support/v4/widget/SlidingPaneLayout;->QX:Landroid/support/v4/widget/ad;
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/ad;->j6(Landroid/view/View;)V
...
.method FH(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/ad;->DW(Landroid/view/View;)V
...
.method Hw(Landroid/view/View;)V
    ...
    .prologue
    .line 353
    invoke-direct/range {p0 .. p0}, Landroid/support/v4/widget/SlidingPaneLayout;->Zo()Z
    ...
    invoke-static/range {p1 .. p1}, Landroid/support/v4/widget/SlidingPaneLayout;->Zo(Landroid/view/View;)Z
...
.method public computeScroll()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/widget/aj;->j6(Z)Z
    ...
    invoke-virtual {v0}, Landroid/support/v4/widget/aj;->Zo()V
...
.method protected drawChild(Landroid/graphics/Canvas;Landroid/view/View;J)Z
    ...
    .line 1000
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->Mr:Landroid/graphics/Rect;
    ...
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->Mr:Landroid/graphics/Rect;
    ...
    .line 1012
    :cond_2
    iget-boolean v3, v0, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->FH:Z

    if-eqz v3, :cond_5

    iget v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->u7:F
...
.method j6(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1, v1}, Landroid/support/v4/widget/ad;->j6(Landroid/view/View;F)V
...
.method j6(FI)Z
    ...
    iget v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->EQ:I
    ...
    .line 1066
    :goto_1
    iget-object v2, p0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;
    ...
    invoke-virtual {v2, v3, v0, v4}, Landroid/support/v4/widget/aj;->j6(Landroid/view/View;II)Z
...
.method protected onDetachedFromWindow()V
    ...
    .line 435
    invoke-virtual {v0}, Landroid/support/v4/widget/ab;->run()V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 766
    iget-object v4, p0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;
    ...
    invoke-virtual {v4, v0, v5, v6}, Landroid/support/v4/widget/aj;->DW(Landroid/view/View;II)Z
    ...
    .line 812
    :goto_2
    iget-object v3, p0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;
    ...
    invoke-virtual {v4, v5, v0, v3}, Landroid/support/v4/widget/aj;->DW(Landroid/view/View;II)Z
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v1, v0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;
    ...
    .line 685
    iget-boolean v3, v1, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->DW:Z
    ...
    :goto_7
    iput-boolean v4, v1, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->FH:Z
    ...
    iget v3, v0, Landroid/support/v4/widget/SlidingPaneLayout;->u7:F

    sub-float/2addr v1, v3

    move-object/from16 v0, p0

    iget v3, v0, Landroid/support/v4/widget/SlidingPaneLayout;->J0:I
...
.method protected onMeasure(II)V
    ...
    iput-object v3, v0, Landroid/support/v4/widget/SlidingPaneLayout;->gn:Landroid/view/View;
    ...
    .line 511
    :cond_5
    iget v4, v1, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->j6:F
    ...
    iput-object v14, v0, Landroid/support/v4/widget/SlidingPaneLayout;->gn:Landroid/view/View;
    ...
    iget-object v4, v0, Landroid/support/v4/widget/SlidingPaneLayout;->gn:Landroid/view/View;
    ...
    .line 631
    iget v1, v1, Landroid/support/v4/widget/SlidingPaneLayout$LayoutParams;->j6:F
    ...
    iput-boolean v7, v0, Landroid/support/v4/widget/SlidingPaneLayout;->VH:Z
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/aj;->j6()I
    ...
    invoke-virtual {v1}, Landroid/support/v4/widget/aj;->Zo()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 843
    iget-object v5, p0, Landroid/support/v4/widget/SlidingPaneLayout;->XL:Landroid/support/v4/widget/aj;

    invoke-virtual {v5}, Landroid/support/v4/widget/aj;->Hw()I
    ...
    invoke-virtual {v3, v4, v1, v2}, Landroid/support/v4/widget/aj;->DW(Landroid/view/View;II)Z
...
.method public setPanelSlideListener(Landroid/support/v4/widget/ad;)V
    .locals 0

    .prologue
    .line 329
    iput-object p1, p0, Landroid/support/v4/widget/SlidingPaneLayout;->QX:Landroid/support/v4/widget/ad;
