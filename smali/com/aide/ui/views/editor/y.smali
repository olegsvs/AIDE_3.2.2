...
.method public constructor <init>(Landroid/graphics/Canvas;)V
    ...
    .line 18
    iput-object p1, p0, Lcom/aide/ui/views/editor/y;->j6:Landroid/graphics/Canvas;
    ...
    iput-object v0, p0, Lcom/aide/ui/views/editor/y;->FH:Landroid/graphics/Paint;

    .line 21
    iget-object v0, p0, Lcom/aide/ui/views/editor/y;->FH:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lcom/aide/ui/views/editor/y;->DW:Landroid/graphics/Paint;
...
# virtual methods
.method public DW()Lcom/aide/ui/views/editor/al;
    .locals 2

    .prologue
    .line 62
    new-instance v0, Lcom/aide/ui/views/editor/al;

    iget-object v1, p0, Lcom/aide/ui/views/editor/y;->j6:Landroid/graphics/Canvas;

    invoke-virtual {v1}, Landroid/graphics/Canvas;->getClipBounds()Landroid/graphics/Rect;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/aide/ui/views/editor/al;-><init>(Landroid/graphics/Rect;)V
...
.method public DW(FFFF)V
    ...
    .prologue
    .line 77
    iget-object v0, p0, Lcom/aide/ui/views/editor/y;->j6:Landroid/graphics/Canvas;

    iget-object v5, p0, Lcom/aide/ui/views/editor/y;->FH:Landroid/graphics/Paint;
...
.method public FH(FFFF)V
    ...
    iget-object v5, p0, Lcom/aide/ui/views/editor/y;->Hw:Landroid/graphics/Paint;
...
.method public j6([CII[F)I
    ...
    .prologue
    .line 128
    iget-object v0, p0, Lcom/aide/ui/views/editor/y;->DW:Landroid/graphics/Paint;
...
.method public j6()Lcom/aide/ui/views/editor/m;
    ...
    iget-object v1, p0, Lcom/aide/ui/views/editor/y;->FH:Landroid/graphics/Paint;
...
.method public j6(Landroid/graphics/Bitmap;FFF)V
    ...
    .line 122
    iget-object v2, p0, Lcom/aide/ui/views/editor/y;->j6:Landroid/graphics/Canvas;
...
.method public j6(Lcom/aide/ui/views/editor/al;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lcom/aide/ui/views/editor/al;->j6()Landroid/graphics/RectF;
...
.method public j6(Lcom/aide/ui/views/editor/m;)V
    ...
    invoke-virtual {p1}, Lcom/aide/ui/views/editor/m;->j6()I
...
.method public j6(Lcom/aide/ui/views/editor/x;)V
    ...
    iget v1, p1, Lcom/aide/ui/views/editor/x;->j6:F
    ...
    iget-object v1, p1, Lcom/aide/ui/views/editor/x;->DW:Landroid/graphics/Typeface;
    ...
    iget-boolean v1, p1, Lcom/aide/ui/views/editor/x;->FH:Z
...
.method public j6(Ljava/lang/String;FF)V
    ...
    iget-object v1, p0, Lcom/aide/ui/views/editor/y;->DW:Landroid/graphics/Paint;
...
.method public j6([CIIFF)V
    ...
    iget-object v6, p0, Lcom/aide/ui/views/editor/y;->DW:Landroid/graphics/Paint;
